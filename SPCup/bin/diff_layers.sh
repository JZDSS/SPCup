...
python ../test_img_level.py --gpu 3 --data_dir /home/amax/data/SPCup2018 --meta_dir ../data/meta --ckpt_dir --8lres/ckpt --blocks 1 --out_file 8lres/valid_log
#20 layers resnet
...
python ../test_img_level.py --gpu 3 --data_dir /home/amax/data/SPCup2018 --meta_dir ../data/meta --ckpt_dir --20lres/ckpt --blocks 3 --out_file 20lres/valid_log
#32 layers resnet
...
python ../test_img_level.py --gpu 3 --data_dir /home/amax/data/SPCup2018 --meta_dir ../data/meta --ckpt_dir --32lres/ckpt --blocks 5 --out_file 32lres/valid_log
